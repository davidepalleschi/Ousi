                    ...
                    {[
                        ...
                        <div key={id} className="space-y-1">
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-transparent border-b border-ousi-stone/40 text-inherit placeholder-ousi-stone/30 pb-2 focus:outline-none focus:border-ousi-tan transition-colors text-sm"
                            />
                        </div>
                    ))}
